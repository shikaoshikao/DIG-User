...
SWIFT_CLASS("_TtC6DIGapp11AppDelegate")
...
@interface UIImage (SWIFT_EXTENSION(DIGapp))
+ (UIImage * __nullable)gifWithData:(NSData * __nonnull)data;
+ (UIImage * __nullable)gifWithURL:(NSString * __nonnull)gifUrl;
+ (UIImage * __nullable)gifWithName:(NSString * __nonnull)name;
+ (double)delayForImageAtIndex:(NSInteger)index source:(CGImageSourceRef __null_unspecified)source;
+ (NSInteger)gcdForArray:(NSArray<NSNumber *> * __nonnull)array;
+ (UIImage * __nullable)animatedImageWithSource:(CGImageSourceRef __nonnull)source;
@end
...
SWIFT_CLASS("_TtC6DIGapp14ViewController")
@interface ViewController : JSQMessagesViewController
@property (nonatomic, copy) NSArray<JSQMessage *> * __nonnull messages;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6DIGapp24activitiesViewController")
...
SWIFT_CLASS("_TtC6DIGapp18chatViewController")
...
SWIFT_CLASS("_TtC6DIGapp18homeViewController")
